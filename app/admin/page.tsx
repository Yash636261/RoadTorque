...
const mockBlogs = [
  ...
  { id: 3, title: "Building Responsive UIs", views: 2100, date: "2024-03-13" },
  {
    id: 4,
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-3xl font-semibold text-gray-900">
                      {Math.round(totalViews / mockBlogs.length)}
                    </dd>
                  </dl>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Link href="/admin/write-review" className="block">
            <div className="bg-white overflow-hidden shadow rounded-lg hover:shadow-lg transition-shadow duration-300">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="text-sm text-gray-500">Create a new review</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Link href="/admin/create-news" className="block">
            <div className="bg-white overflow-hidden shadow rounded-lg hover:shadow-lg transition-shadow duration-300">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
