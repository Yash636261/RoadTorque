    ...
    <div className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-10 px-4 py-10 md:px-6 md:py-20 lg:grid-cols-2">
      <div className="relative flex flex-col items-center overflow-hidden lg:items-start">
        ...
        <div className="div relative mt-20 flex w-[600px] flex-shrink-0 -translate-x-10 items-center justify-center [perspective:800px] [transform-style:preserve-3d] sm:-translate-x-0 lg:-translate-x-32">
          <div
            className="pointer-events-none absolute right-1 top-0 z-[60] flex h-40 w-96 items-center justify-center opacity-100 transition duration-500"
          ...
          >
            <div className="h-full w-full">
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    transform:
                      "translateX(-50%) translateY(-50%) scale(0.0725213)",
                  }}
                ></div>
                <div
                  className="absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)] dark:bg-sky-500/[0.2]"
                  style={{
                    ...
                    willChange: "opacity, transform",
                    transform:
                      "translateX(-50%) translateY(-50%) scale(0.87863)",
                  }}
                ></div>
                <div
                  className="absolute left-1/2 top-1/2 h-20 w-20 -translate-x-1/2 -translate-y-1/2 rounded-[50%] bg-sky-500/[0.08] shadow-[0_8px_16px_rgb(0_0_0/0.4)] dark:bg-sky-500/[0.2]"
                  style={{
                    ...
                    willChange: "opacity, transform",
                    transform:
                      "translateX(-50%) translateY(-50%) scale(0.54353)",
                  }}
                ></div>
              </div>
              ...
              <div className="absolute bottom-1/2 right-1/2 h-20 w-px translate-y-[14px] bg-gradient-to-b from-transparent to-blue-500"></div>
              <div className="absolute bottom-1/2 right-1/2 z-40 h-[4px] w-[4px] translate-x-[1.5px] translate-y-[14px] rounded-full bg-blue-600 blur-[3px]"></div>
              <div className="absolute bottom-1/2 right-1/2 z-40 h-[2px] w-[2px] translate-x-[0.5px] translate-y-[14px] rounded-full bg-blue-300"></div>
            </div>
          </div>
          <Image
            alt="world map"
      ...
      >
        ...
        <div className="relative z-20 mb-4 w-full">
          ...
          <input
            id="email"
            placeholder="support@Ev-way.com"
            className="h-10 w-full rounded-md border border-transparent bg-white pl-4 text-sm text-neutral-700 placeholder-neutral-500 shadow-input outline-none focus:outline-none focus:ring-2 focus:ring-neutral-800 active:outline-none dark:border-neutral-800 dark:bg-neutral-800 dark:text-white"
            type="email"
            {...form.register("email")}
          />
        ...
        <button
          ...
          className="relative z-10 flex items-center justify-center rounded-md border border-transparent bg-neutral-800 px-4 py-2 text-sm font-medium text-white shadow-[0px_1px_0px_0px_#FFFFFF20_inset] transition duration-200 hover:bg-neutral-900 md:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
        >
